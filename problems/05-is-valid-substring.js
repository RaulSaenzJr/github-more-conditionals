...
// Your code here 
// Define a function isValidSubStr that takes in two string parameters

function isValidSubStr(str1, str2) { 
    // if the second string is part of the first string regardless of the casing of the characters, return 'VALID'
